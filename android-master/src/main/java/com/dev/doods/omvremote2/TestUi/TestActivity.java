...
public class TestActivity extends AppCompatActivity {
    ...
    {
        super.onPostResume();
        LinearLayoutTest.addView(MainApp.mAdViewSmall);
    ...
    {
        super.onPause();
        LinearLayoutTest.removeView(MainApp.mAdViewSmall);
    }
