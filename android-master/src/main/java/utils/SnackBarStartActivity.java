...
public class SnackBarStartActivity {
    ...
    private void set(View v, String message, final Class<?> cls)
    {
        ...
        Snackbar snackbar = Snackbar
                ...
                .setAction(MainApp.getAppContext().getString(R.string.fix_Error), new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent i = new Intent( MainApp.getAppContext(), cls);
                        i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        MainApp.getAppContext().startActivity(i);
                    }
                });
