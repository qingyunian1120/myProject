...
import static com.owncloud.android.MainApp.getAppContext;
...
private View mView;
    ...
    private void set(View v, String message)
    {
        ...
        Snackbar snackbar = Snackbar
                ...
                .setAction(getAppContext().getString(R.string.send_logs), new View.OnClickListener() {
                    @Override
    ...
    {
        AsyncTask task = new SendLogsTask(MainApp.getAppContext());
